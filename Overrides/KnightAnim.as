...
void onTick(CSprite@ this)
{
	...
	{
		if (knight.swordTimer < getSlashCharge(blob))
		{
			this.SetAnimation("draw_sword");
		}
		else if (knight.swordTimer < getSlashChargeLevel2(blob))
		{
	...
	if (shiny !is null)
	{
		...
		if (shinydot)
		{
			f32 range = (KnightVars::slash_charge_limit - getSlashChargeLevel2(blob));
			f32 count = (knight.swordTimer - getSlashChargeLevel2(blob));
